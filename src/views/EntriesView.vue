  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">Enter all the entries in your show including their title, event, and people. These can be in any order. Jump Rope Show Creator does not save anything for you! Download your entries to get them back later. When you are done go back to the <TabReference to="/show">Show</TabReference> tab.</p>
      </div>
        ...
        <div class="inline-block min-w-full py-2 align-middle">
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tr>
              ...
              <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6 lg:pl-8">Name <span class="text-gray-500">(optional)</span></th>
              ...
              <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6 lg:pl-8">Lock Location Percent <span class="text-gray-500">(optional)</span></th>
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr v-for="(entry, index) in entries.entries" :key="index">
                ...
                <td class="relative whitespace-nowrap pl-3 pr-4 text-right text-sm font-medium sm:pr-6 lg:pr-8">
